...
BibOptions(check.entries = FALSE, bib.style = "authoryear", style = "markdown",
           dashed = TRUE)
bib <- ReadBib("/home/grant/Dropbox/LaTeX/BiBTeX")
...
--
count: false
This paper: Bridge the gap between theory and empirics. 

---

# Approach and contribution

I exploit exogenous variation in the formation of localized electricity markets. 
- Source: Transmission constraints.
- Provides a setting in which the *definition* of the market is changing over time.

Pair this variation with plant-level data on Norwegian hydropower producers.
- Hydropower will offer specific empirical advantages (more on this later).

Identify the causal impact of market power on firm behaviour.
- Do firms withold production when they gain more market power?
...
(Or: Why should you care about hydropower?)

---

# Increasing concern about market power
...
### Producer's decision
- Driven by the opportunity cost of water.
...
- <span style="color:#0c5999">Wolfram (1999)</span>, <span style="color:#0c5999">Joskow and Tirole (2000)</span>, <span style="color:#0c5999">Borenstein et al. (2000, 2002)</span>, <span style="color:#0c5999">Puller (2007)</span>, <span style="color:#0c5999">Reguant (2014)</span>, and <span style="color:#0c5999">Davis and Hausman (2016)</span>.
- This study: More advantageous research design. Richer variation in market power over longer period of time.

### Nordic focus
- <span style="color:#0c5999">Johnsen et al. (1999)</span>, <span style="color:#0c5999">Steen (2004)</span>, <span style="color:#0c5999">Kauppi and Liski (2008)</span>, <span style="color:#0c5999">Fridolfsson and Tangerås (2009)</span> and <span style="color:#0c5999">Mirza and Bergland (2012)</span>.
...
- Electricity data over the same period.
  - Prices and flows per bidding area. (Link.)
  - Transmission constraints and boundary changes. (Link.)
- <span style="color:#BDBDBD">Electricity bid curve data from 2014-2017.</span>
  - <span style="color:#BDBDBD">Direct estimates of seasonal elasticities.</span>
...
- I exploit exogenous variation in market power among Norwegian electricity firms (source: transmission constraints).
- Pair this variation with a rich dataset of Norwegian hydropower firms and electricity flows.
...
- Numerous reasons to view these results as a lower bound on the welfare costs associated with market power.

### Policy relevance
- Even seemingly competitive markets are susceptible to manipulation and welfare losses.
